...
<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
          ...
          <button type="button" class="btn btn-outline-dark shadow-none me-lg-2 mr-2" data-toggle="modal" data-target="#loginModal">
            Log In
          </button>
        ...
        <div class="modal-content">
          <form action="loginn.php" method="post">
            ...
            <div class="modal-header">
              <h5 class="modal-title d-flex align-items-center" > <i class="bi bi-person-circle h2 m-2"></i> User Login</h5>
            ...
            <div class="modal-body">
              <div class="form-group mb-3">
                ...
                <input type="email" name="emails" class="form-control shadow-none">
              </div>
              <div class="form-group mb-4">
                <label >Password</label>
                <input type="password" name="passs" class="form-control shadow-none">
              </div>
              <div class="d-flex justify-content-between align-items-center mb-2">
                <button type="submit " name="sub" class="btn btn-dark shadow-none">Log In</button>
      ...
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <form action="signup.php" method="POST" id="register-form">
            ...
            <div class="modal-header">
              <h5 class="modal-title d-flex align-items-center" > <i class="bi bi-person-lines-fill h2 m-2"></i> User Login</h5>
              <button type="reset" class="close shadow-none text-reset" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <span class="badge badge-pill badge-light text-dark mb-3 text-wrap lh-base">
               Note: Your details must match with your ID(Aadhar,DV,etc.)
              </span>
              <div class="container-fluid">
                ...
                <div class="text-center my-1">
                  <button type="submit" name="regin" class="btn btn-dark shadow-none">REGISTER</button>
